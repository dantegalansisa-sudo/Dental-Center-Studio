    ...
    <>
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        <a href="/" className="navbar__logo" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <img src="/imagenes/dentalstudio/logo.png" alt="Dental Center Studio" className="navbar__logo-img"
          ...
          <span style={{ fontFamily: 'var(--font-brutal)', fontSize: '13px', letterSpacing: '0.08em',
                         color: 'var(--primary)', textTransform: 'uppercase' as const, lineHeight: '1.2' }}>DENTAL CENTER STUDIO</span>
        </a>
