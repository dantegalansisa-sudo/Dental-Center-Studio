...
export const articles: Article[] = [
  {
    ...
    content: [
      ...
      'En Dental Center Studio evaluamos cada caso de forma personalizada. Durante tu consulta, analizaremos el estado de tus dientes, tus expectativas y tu presupuesto para recomendarte el tratamiento que mejor se adapte a ti.',
    ],
    tips: [
  ...
  },
  {
    ...
    content: [
      ...
      'En Dental Center Studio utilizamos tecnología de diagnóstico 3D para planificar cada implante con precisión milimétrica, asegurando los mejores resultados posibles para cada paciente.',
    ],
    tips: [
  ...
  },
  {
    ...
    content: [
      ...
      'En Dental Center Studio creemos que la prevención es la mejor inversión en tu salud dental. Nuestro equipo está disponible para enseñarte las técnicas correctas y crear un plan de prevención personalizado.',
    ],
    tips: [
