...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    // Hero
    'hero.tagline': 'Clínica Dental Boutique — Bella Vista, DN',
    'hero.title1': 'TU',
    'hero.title2': 'SONRISA',
    ...
    // Footer
    'footer.tagline': 'Clínica Dental Boutique — Bella Vista, DN',
    'footer.rights': '© 2026 Dental Center Studio. Todos los derechos reservados.',
  ...
  en: {
    ...
    // Hero
    'hero.tagline': 'Boutique Dental Clinic — Bella Vista, DN',
    'hero.title1': 'YOUR',
    'hero.title2': 'SMILE',
    ...
    // Footer
    'footer.tagline': 'Boutique Dental Clinic — Bella Vista, DN',
    'footer.rights': '© 2026 Dental Center Studio. All rights reserved.',
