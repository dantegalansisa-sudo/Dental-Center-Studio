    ...
    <section className="director section">
      <div className="section-container">
        <div className="director__grid">
          ...
          >
            <img
              src="/imagenes/dentalstudio/logo.png"
              alt="Dental Center Studio — Director"
          ...
          <div className="director__content">
            ...
            >
              ...
              <span className="director__credential-dot" />
              <span className="director__credential">Implantes</span>
            </motion.div>
            ...
            >
              "Dental Center Studio es una clínica dental boutique comprometida con brindar atención odontológica personalizada y de alta calidad en un ambiente moderno."
            </motion.blockquote>
            ...
            >
              ...
              <span className="director__signature-role">Director — Dental Center Studio</span>
            </motion.div>
          </div>
        </div>
      </div>
