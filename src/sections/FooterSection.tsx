  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">DENTAL CENTER STUDIO</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/dentalcenterstudio" className="footer__social-link interactive" aria-label="Instagram">
